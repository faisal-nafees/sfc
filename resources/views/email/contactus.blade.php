            ...
            <tr>
                <td align="center" valign="top" id="bodyCell">
                    ...
                    <!--
						...
						-->
                    <table bgcolor="#000000" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <!--
									...
									-->
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#000000;"
                                    bgcolor="#ffffff">
                                    <tr>
                                        <td align="center" valign="top">
                                            <!-- FLEXIBLE CONTAINER // -->
                                                    ...
                                                    <td valign="top" width="500" class="flexibleContainerCell">
                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" class="textContent">
                                                                    <img src="http://lv.kdeproduction.net/img/Safety%20First%20Logo.png"
                                                                        width="173" class="flexibleImageSmall"
                                                                        style="max-width:100px;" alt="Text"
                                                                        title="Text" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="20" align="center">
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1
                                                                        style="color:#000000;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:5px;">
                                                                        You have a message from {{@$name}} </h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="10">
                                                            <tr>
                                                                <td width="50%">
                                                                    <div
                                                                        style="font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:16px;margin-bottom:10px;color:#000000;line-height:135%;">
                                                                        Name</div>
                                                                    <div
                                                                        style="font-weight:bold;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:10px;color:#000000;line-height:135%;">
                                                                        {{@$name}}</div>
                                                                </td>
                                                                <td width="50%">
                                                                    <div
                                                                ...
                                                                <td valign="top" bgcolor="#E1E1E1">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>Copyright &#169; 2020 <a
                                                                                href="https://lv2.kdeproduction.net/"
                                                                                target="_blank"
                                                                                style="text-decoration:none;color:#828282;"><span
                                                                                    style="color:#828282;">SFC</span></a>.
